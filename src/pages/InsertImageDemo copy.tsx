...
// https://rmgltopxktqojlntsfls.supabase.co/storage/v1/object/public/avatars/bernard.jpg
...
export default function InsertImageDemo() {
    ...
    async function onSubmit(data: FormData) {
        ...
        const { data:imageData, error: storageError } = await supabase.storage.from('avatars').upload(`${imageName.name}`, imageName, {
            cacheControl: '3600',
            upsert: false
          })
